...
<body>
                    ...
                    <?php 
                        ...
                        <?php 
                            ...
                            if($total>0){
                                ...
                                <!-- <button type="submit" class="center" name="submit" style="background-color: #FF5F15; width: 60%;margin-left: 60px; border: none;height: 30px;border-radius: 20px;color: white;font-weight: bold;border-bottom-width:0px;" class="btn">Confirm and Pay</button> -->
                                <?php
                            }else{
                                echo '';
    ...
    <form action="checkout.php">
        <button type="submit" class="center" name="submit" style="background-color: #FF5F15; margin-top:5%; width: 28%;margin-left: 63%; border: none;height: 30px;color: white;font-weight: bold;border-bottom-width:0px;" class="btn">Confirm and Pay</button>
    </form>
</body>
</html>