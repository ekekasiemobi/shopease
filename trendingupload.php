...
if(isset($_POST['upload'])){
    ...
    if(in_array($imgfiletype,$extensions_arr)){
        if(move_uploaded_file($_FILES['ImageFile']['tmp_name'],$img_dir.$imgname)){
            $sql = "insert into trendingupload(imgname, productprice,productname, itemleft) values('$imgname', '$productprice', '$productname', '$itemleft')";
            if (mysqli_query($conn,$sql)) {
                // echo "<script>alert('Image Uploaded Successfully')</script>";
                header("Location:admintrendingupload.php");
            }else{
            ...
            <form style="margin-left:20%" action="" enctype="multipart/form-data" method="POST">
                <div class="row">
                    ...
                    <div class="col s12 m5 l5">
                        <input style="color: black;" type="text" required  name="pname" placeholder="imgname">
                    </div>
                    <div class="col s12 m5 l5">
                        <input style="color: black;" type="text"  required   name="price" placeholder="productprice">
                    </div>
                </div>
                <div class="row">

                    <div class="col s12 m5 l5 ">
                        <input style="color: black;" type="text"  required   name="item" placeholder="no item left">
                    </div>
