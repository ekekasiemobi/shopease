<?php
    ...
    $sqr = "SELECT * FROM electronicsupload";
               ...
               <div class="container">
                    <div class="row">
                            <div class="col s12 m6 l6">
                                ...
                                <a href="electronicsupload.php"> <button class="btn white" style="color:#5F6982; margin-left:50%; border-radius:10px; font-weight:600">Upload File</button>  </a>
                ...
                <div style="margin-left: 30%;"  class="row">
                    ...
                    <?php
                        ...
                        <div style="margin-top: 10%;" class="col s12 l4 m4">
                            <div style="height:250px;" class="card hoverable ">
                                <div class="card-img">
