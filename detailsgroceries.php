...
if (isset($_GET['id'])) {
    // echo  $id =$_GET['id'];
    $id =$_GET['id'];
    $sql = "SELECT * FROM groceriesupload WHERE id = '$id'";
    ...
    if ($result = mysqli_query($conn, $sql)) {
        if (mysqli_num_rows($result) > 0) {
           ...
           $itemleft =  $data['itemleft']; echo "<br/>";
    ...
    <form action="cartlist.php" method="GET"> 
        <div class="container">
            <div class="row">
                ...
                <input style="border-bottom-width: 0px;font-size:24px;color:black;font-weight:bold;" locked type="text" name="itemleft" value="<?php echo $itemleft ?>">
