...
<body>  
    <div  class="container center">
        <h4 style="font-weight: bold">Explore Beauty categories</h4>
    </div>
                ...
                <?php
                    ...
                    <div style="margin-top: 10%;" class="col s12 l3 m3">
                        <div style="height:260px;" class="card hoverable ">
                            ...
                            <div class="card-img">
                              <a href="detailsbeauty.php?id=<?php echo $datas['id']?>"><img src="img/<?php echo $datas['imgname'] ?>" alt=""class="responsive-img"></a>
                            </div>
