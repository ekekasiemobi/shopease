               ...
               <div class="container">
                    <div class="row">
                            <div class="col s12 m6 l6">
                                ...
                                <a href="c&aupload.php"> <button class="btn white" style="color:#5F6982; margin-left:50%; border-radius:10px; font-weight:600">Upload File</button>  </a>
