...
if(isset($_POST['upload'])){
    ...
    if(in_array($imgfiletype,$extensions_arr)){
        if(move_uploaded_file($_FILES['ImageFile']['tmp_name'],$img_dir.$imgname)){
            $sql = "insert into c_aupload(imgname, productprice,productname, itemleft) values('$imgname', '$productprice', '$productname', '$itemleft')";
            if (mysqli_query($conn,$sql)) {
                // echo "<script>alert('Image Uploaded Successfully')</script>";
                header("Location:adminc&aupload.php");
            }else{
            ...
            <form style="margin-left:20%" action="" enctype="multipart/form-data" method="POST">
                <div class="row">
                    ...
                    <div class="col s12 m5 l5">
                        <input style="color: black;" type="text"  name="pname" required placeholder="imgname">
                    </div>
                    <div class="col s12 m5 l5">
                        <input style="color: black;" type="text"  name="price" required placeholder="productprice">
                    </div>
                </div>
                <div class="row">

                    <div class="col s12 m5 l5 ">
                        <input style="color: black;" type="text"   name="item" required placeholder="no item left">
                    </div>
