...
<body>  
    <div  class="container center">
        <h4 style="font-weight: bold">Explore Shoes & Bags categories</h4>
    </div>
   ...
   <div style="margin-left: 10%; margin-right:10%;">
        <div>
            <div  class="row">
                ...
                <?php
                    $sqv = "SELECT * FROM shoes_bagsupload";
                   ...
                   <div style="margin-top: 10%;" class="col s12 l3 m3">
                        <div style="height:260px;" class="card hoverable ">
                            ...
                            <div class="card-img">
                              <a href="detailsshoes&bags.php?id=<?php echo $datas['id']?>"><img src="img/<?php echo $datas['imgname'] ?>" alt=""class="responsive-img"></a>
                            </div>
